...
#Source Data
sd_df = pd.read_excel("C:/Users/shanm/Documents/git/ADS_2assignment/API_19_DS2_en_excel_v2_5360124.xls", header=3)
...
Bhutan = Bhutan.loc[('1980', '1985', '1990', '1995', '2000', '2005', '2010'), ('Renewable energy consumption (% of total final energy consumption)', 'Other greenhouse gas emissions (% change from 1990)', 'Arable land (% of land area)', 'Forest area (% of land area)', 'Population growth (annual %)','Urban population growth (annual %)','Agricultural land (% of land area)','Cereal yield (kg per hectare)','CO2 emissions (kt)')]
...
plt.plot(Bhutan.index, Bhutan.loc[:, 'Arable land (% of land area)'], label='Bhutan')
...
plt.plot(Bhutan.index, Bhutan.loc[:, 'Forest area (% of land area)'], label='Bhutan')
